...
function App() {
  return (
    <>
      <div>
        <h1>Button</h1>
        <Button click={largePrimary} wd={"200px"} hg={"60px"} bor="2px solid rgb(85, 239, 196)" bgColor="white">Large Primary Button</Button>
      ...
      <div>
        <Button click={largeNegative} wd={"200px"} hg={"60px"} bor="2px solid rgb(250, 177, 160)" bgColor="white">Large Negative Button</Button>
